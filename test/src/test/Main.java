...
//public final static int TCS34725_ID               = 0x12; // 0x44 = TCS34721/TCS34725, 0x4D = TCS34723/TCS34727
  ...
  public Main(int address) throws IOException
  {
    this(address, 0xff);
  }
  
  public Main(boolean b, int integrationTime) throws IOException
  {
    this(TCS34725_ADDRESS, integrationTime);
  }
  
  public Main(int address, int integrationTime) throws IOException
  {
  ...
  public static void main(String[] args)
  {
    ...
    try 
    {
    	Main sensor = new Main(TCS34725_ADDRESS, TCS34725_INTEGRATIONTIME_2_4MS);
    	sensor.enable();
