...
public class PN532I2C implements IPN532Interface {
	...
	@Override
	public CommandStatus writeCommand(byte[] header, byte[] body) throws InterruptedException, IOException {
	...
	@Override
	public CommandStatus writeCommand(byte[] header) throws InterruptedException, IOException {
